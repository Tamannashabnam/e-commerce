...
<head>
	...
	<script src="https://kit.fontawesome.com/6dac8b3772.js" crossorigin="anonymous"></script>
	...
	<style>
		#navigation {
			...
			background: -webkit-linear-gradient(to right, #E67E22, #C70039);
		...
		#header {
			...
			/* Chrome 10-25, Safari 5.1-6 */
			background: linear-gradient(to right, #0D7C6B, #3498DB);
			/* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
		...
		#top-header {
			...
			/* Chrome 10-25, Safari 5.1-6 */
			background: linear-gradient(to right, green, #145A32);
			/* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
		...
		#footer {
			...
			/* Chrome 10-25, Safari 5.1-6 */
			background: linear-gradient(to right, #4B6A58, #4B6A58);
			/* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
		...
		<div id="top-header">
			<div class="container">
				<ul class="header-links pull-left">
					...
					<li><a href="#"><i class="fa fa-envelope-o"></i>1821801@iub.edu.bd </a></li>
